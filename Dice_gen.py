...
d3_button = Button(frame2, text='D3', command=dice3)
d5_button = Button(frame2, text='D5', command=dice5)
d7_button = Button(frame2, text='D7', command=dice7)
d14_button = Button(frame2, text='D14', command=dice14)
d16_button = Button(frame2, text='D16', command=dice16)
d24_button = Button(frame2, text='D24', command=dice24)
d30_button = Button(frame2, text='D30', command=dice30)
